...
%\usepackage{newtxtext,newtxmath}\DeclareMathSizes{\@xipt}{\@xipt}{7}{5}
\usepackage{tikz}
\usepackage[italian]{babel}
%\usepackage{datetime}
\usepackage{booktabs}
\usepackage{setspace}
%\usepackage{concmath}\DeclareMathSizes{10}{10}{8}{7}
%\usepackage{helvet}
...
\hypersetup{pdfauthor={Massimo D'Antoni},
 pdftitle={Lo stato fornitore di beni e servizi\newline (beni pubblici e monopolio)},
 pdflang={Italian}}
\begin{document}
